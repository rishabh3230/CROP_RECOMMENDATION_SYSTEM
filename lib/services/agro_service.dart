  ...
  static Future<List<CropProfit>> fetchCropProfits() async {
    ...
    return const [
      ...
      CropProfit(
        cropName: 'Cotton',
        emoji: '☁️',
        profitPerHectare: 2150,
        marketPrice: 6200,
        productionCost: 4050,
        growthPercent: 12.5,
        category: 'Cash Crop',
        monthlyData: [
          MonthlyProfit('Jan', 1200), MonthlyProfit('Feb', 1400),
          MonthlyProfit('Mar', 1800), MonthlyProfit('Apr', 2150),
          MonthlyProfit('May', 2000), MonthlyProfit('Jun', 1600),
          MonthlyProfit('Jul', 1100), MonthlyProfit('Aug', 900),
          MonthlyProfit('Sep', 1300), MonthlyProfit('Oct', 1800),
          MonthlyProfit('Nov', 1600), MonthlyProfit('Dec', 1300),
        ],
      ),
      CropProfit(
        cropName: 'Garlic',
        emoji: '🧄',
        profitPerHectare: 5200,
        marketPrice: 4500,
        productionCost: 1800,
        growthPercent: 18.2,
        category: 'Spice',
        monthlyData: [
          MonthlyProfit('Jan', 1500), MonthlyProfit('Feb', 1800),
          MonthlyProfit('Mar', 2800), MonthlyProfit('Apr', 5200),
          MonthlyProfit('May', 4800), MonthlyProfit('Jun', 3200),
          MonthlyProfit('Jul', 1800), MonthlyProfit('Aug', 1200),
          MonthlyProfit('Sep', 1500), MonthlyProfit('Oct', 2200),
          MonthlyProfit('Nov', 1900), MonthlyProfit('Dec', 1600),
        ],
      ),
      CropProfit(
        cropName: 'Mustard',
        emoji: '🌻',
        profitPerHectare: 1150,
        marketPrice: 5400,
        productionCost: 4250,
        growthPercent: 6.8,
        category: 'Oilseed',
        monthlyData: [
          MonthlyProfit('Jan', 300), MonthlyProfit('Feb', 450),
          MonthlyProfit('Mar', 1150), MonthlyProfit('Apr', 1050),
          MonthlyProfit('May', 800), MonthlyProfit('Jun', 600),
          MonthlyProfit('Jul', 400), MonthlyProfit('Aug', 350),
          MonthlyProfit('Sep', 420), MonthlyProfit('Oct', 200),
          MonthlyProfit('Nov', 150), MonthlyProfit('Dec', 200),
        ],
      ),
      CropProfit(
        cropName: 'Onion',
        emoji: '🧅',
        profitPerHectare: 2800,
        marketPrice: 1800,
        productionCost: 1100,
        growthPercent: 14.1,
        category: 'Vegetable',
        monthlyData: [
          MonthlyProfit('Jan', 800), MonthlyProfit('Feb', 1100),
          MonthlyProfit('Mar', 1900), MonthlyProfit('Apr', 2800),
          MonthlyProfit('May', 2500), MonthlyProfit('Jun', 1800),
          MonthlyProfit('Jul', 1200), MonthlyProfit('Aug', 800),
          MonthlyProfit('Sep', 1100), MonthlyProfit('Oct', 1600),
          MonthlyProfit('Nov', 1400), MonthlyProfit('Dec', 900),
        ],
      ),
      CropProfit(
        cropName: 'Soybean',
        emoji: '🫘',
        profitPerHectare: 1420,
        marketPrice: 3800,
        productionCost: 2380,
        growthPercent: 9.3,
        category: 'Oilseed',
        monthlyData: [
          MonthlyProfit('Jan', 500), MonthlyProfit('Feb', 450),
          MonthlyProfit('Mar', 600), MonthlyProfit('Apr', 850),
          MonthlyProfit('May', 1100), MonthlyProfit('Jun', 1420),
          MonthlyProfit('Jul', 1350), MonthlyProfit('Aug', 1100),
          MonthlyProfit('Sep', 900), MonthlyProfit('Oct', 600),
          MonthlyProfit('Nov', 450), MonthlyProfit('Dec', 400),
        ],
      ),
    ];
  }
